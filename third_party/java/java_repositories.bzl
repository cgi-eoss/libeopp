...
ARTIFACTS = [
    ...
    maven.artifact("com.azure", "azure-core", "1.28.0"),
    maven.artifact("com.azure", "azure-core-http-netty", "1.12.0"),
    maven.artifact("com.azure", "azure-storage-blob", "12.16.1"),
    maven.artifact("com.azure", "azure-storage-common", "12.15.2"),
    maven.artifact("com.azure", "azure-storage-internal-avro", "12.2.2"),
    ...
    maven.artifact("com.google.protobuf", "protobuf-java", "3.21.1"),
    maven.artifact("com.google.protobuf", "protobuf-java-util", "3.21.1"),
    maven.artifact("com.google.protobuf", "protobuf-javalite", "3.21.1"),
    maven.artifact("com.google.protobuf", "protobuf-kotlin", "3.21.1"),
    ...
    maven.artifact("com.networknt", "json-schema-validator", "1.0.70"),
    ...
    maven.artifact("io.netty", "netty-tcnative-boringssl-static", "2.0.52.Final"),
    maven.artifact("io.netty", "netty-tcnative-classes", "2.0.52.Final"),
    ...
    maven.artifact("net.bytebuddy", "byte-buddy-agent", "1.12.10"),
    ...
    maven.artifact("org.jetbrains.kotlinx", "kotlinx-coroutines-core-jvm", "1.6.2"),
    maven.artifact("org.jetbrains.kotlinx", "kotlinx-coroutines-debug", "1.6.2"),
    ...
    maven.artifact("org.pitest", "pitest", "1.8.0"),
    maven.artifact("org.pitest", "pitest-aggregator", "1.8.0"),
    maven.artifact("org.pitest", "pitest-command-line", "1.8.0"),
    maven.artifact("org.pitest", "pitest-entry", "1.8.0"),
    maven.artifact("org.pitest", "pitest-html-report", "1.8.0"),
    maven.artifact("org.reactivestreams", "reactive-streams", "1.0.3"),
    maven.artifact("org.slf4j", "slf4j-api", "1.7.36"),
    maven.artifact("org.springframework.boot", "spring-boot", "2.7.0"),
    maven.artifact("org.springframework.cloud", "spring-cloud-commons", "3.1.3"),
    maven.artifact("org.springframework.security", "spring-security-crypto", "5.7.1"),
    ...
    maven.artifact("software.amazon.awssdk", "annotations", "2.17.201"),
    maven.artifact("software.amazon.awssdk", "apache-client", "2.17.201"),
    maven.artifact("software.amazon.awssdk", "arns", "2.17.201"),
    maven.artifact("software.amazon.awssdk", "auth", "2.17.201"),
    maven.artifact("software.amazon.awssdk", "aws-core", "2.17.201"),
    maven.artifact("software.amazon.awssdk", "aws-query-protocol", "2.17.201"),
    maven.artifact("software.amazon.awssdk", "aws-xml-protocol", "2.17.201"),
    maven.artifact("software.amazon.awssdk", "http-client-spi", "2.17.201"),
    maven.artifact("software.amazon.awssdk", "json-utils", "2.17.201"),
    maven.artifact("software.amazon.awssdk", "metrics-spi", "2.17.201"),
    maven.artifact("software.amazon.awssdk", "netty-nio-client", "2.17.201"),
    maven.artifact("software.amazon.awssdk", "profiles", "2.17.201"),
    maven.artifact("software.amazon.awssdk", "protocol-core", "2.17.201"),
    maven.artifact("software.amazon.awssdk", "regions", "2.17.201"),
    maven.artifact("software.amazon.awssdk", "s3", "2.17.201"),
    maven.artifact("software.amazon.awssdk", "sdk-core", "2.17.201"),
    maven.artifact("software.amazon.awssdk", "third-party-jackson-core", "2.17.201"),
    maven.artifact("software.amazon.awssdk", "utils", "2.17.201"),
