...
ARTIFACTS = [
    ...
    maven.artifact("com.fasterxml.jackson.core", "jackson-annotations", "2.11.1"),
    maven.artifact("com.fasterxml.jackson.core", "jackson-core", "2.11.1"),
    maven.artifact("com.fasterxml.jackson.core", "jackson-databind", "2.11.1"),
    maven.artifact("com.fasterxml.jackson.dataformat", "jackson-dataformat-yaml", "2.11.1"),
    ...
    maven.artifact("com.squareup.okhttp3", "logging-interceptor", "4.8.0"),
    maven.artifact("com.squareup.okhttp3", "mockwebserver", "4.8.0", testonly = True),
    maven.artifact("com.squareup.okhttp3", "okhttp", "4.8.0"),
    ...
    maven.artifact("io.grpc", "grpc-api", "1.30.2"),
    maven.artifact("io.grpc", "grpc-context", "1.30.2"),
    maven.artifact("io.grpc", "grpc-core", "1.30.2"),
    maven.artifact("io.grpc", "grpc-netty", "1.30.2"),
    maven.artifact("io.grpc", "grpc-protobuf", "1.30.2"),
    maven.artifact("io.grpc", "grpc-protobuf-lite", "1.30.2"),
    maven.artifact("io.grpc", "grpc-services", "1.30.2"),
    maven.artifact("io.grpc", "grpc-stub", "1.30.2"),
    ...
    maven.artifact("io.projectreactor", "reactor-core", "3.3.8.RELEASE"),
    maven.artifact("javax.annotation", "javax.annotation-api", "1.3.2", neverlink = True),
    maven.artifact("junit", "junit", "4.13", testonly = True),
    maven.artifact("net.bytebuddy", "byte-buddy", "1.10.13"),
    maven.artifact("net.bytebuddy", "byte-buddy-agent", "1.10.13"),
    ...
    maven.artifact("software.amazon.awssdk", "annotations", "2.13.61"),
    maven.artifact("software.amazon.awssdk", "apache-client", "2.13.61"),
    maven.artifact("software.amazon.awssdk", "arns", "2.13.61"),
    maven.artifact("software.amazon.awssdk", "auth", "2.13.61"),
    maven.artifact("software.amazon.awssdk", "aws-core", "2.13.61"),
    maven.artifact("software.amazon.awssdk", "aws-query-protocol", "2.13.61"),
    maven.artifact("software.amazon.awssdk", "aws-xml-protocol", "2.13.61"),
    maven.artifact("software.amazon.awssdk", "http-client-spi", "2.13.61"),
    maven.artifact("software.amazon.awssdk", "metrics-spi", "2.13.61"),
    maven.artifact("software.amazon.awssdk", "netty-nio-client", "2.13.61"),
    maven.artifact("software.amazon.awssdk", "profiles", "2.13.61"),
    maven.artifact("software.amazon.awssdk", "protocol-core", "2.13.61"),
    maven.artifact("software.amazon.awssdk", "regions", "2.13.61"),
    maven.artifact("software.amazon.awssdk", "s3", "2.13.61"),
    maven.artifact("software.amazon.awssdk", "sdk-core", "2.13.61"),
    maven.artifact("software.amazon.awssdk", "utils", "2.13.61"),
