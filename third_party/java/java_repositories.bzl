...
ARTIFACTS = [
    ...
    maven.artifact("com.google.protobuf", "protobuf-javalite", "3.19.4"),
    ...
    maven.artifact("com.networknt", "json-schema-validator", "1.0.67"),
    ...
    maven.artifact("io.grpc", "grpc-alts", "1.45.0"),
    maven.artifact("io.grpc", "grpc-api", "1.45.0"),
    maven.artifact("io.grpc", "grpc-auth", "1.45.0"),
    maven.artifact("io.grpc", "grpc-census", "1.45.0"),
    maven.artifact("io.grpc", "grpc-context", "1.45.0"),
    maven.artifact("io.grpc", "grpc-core", "1.45.0"),
    maven.artifact("io.grpc", "grpc-grpclb", "1.45.0"),
    maven.artifact("io.grpc", "grpc-netty", "1.45.0"),
    maven.artifact("io.grpc", "grpc-netty-shaded", "1.45.0"),
    maven.artifact("io.grpc", "grpc-protobuf", "1.45.0"),
    maven.artifact("io.grpc", "grpc-protobuf-lite", "1.45.0"),
    maven.artifact("io.grpc", "grpc-services", "1.45.0"),
    maven.artifact("io.grpc", "grpc-stub", "1.45.0"),
    ...
    maven.artifact("io.netty", "netty-resolver-dns-classes-macos", "4.1.74.Final"),
    maven.artifact("io.netty", "netty-resolver-dns-native-macos", "4.1.74.Final", classifier = "osx-x86_64"),
    ...
    maven.artifact("io.netty", "netty-transport-classes-kqueue", "4.1.74.Final"),
    maven.artifact("io.netty", "netty-transport-native-epoll", "4.1.74.Final", classifier = "linux-x86_64"),
    maven.artifact("io.netty", "netty-transport-native-kqueue", "4.1.74.Final", classifier = "osx-x86_64"),
    ...
    maven.artifact("io.projectreactor.netty", "reactor-netty-core", "1.0.16"),
    maven.artifact("io.projectreactor.netty", "reactor-netty-http", "1.0.16"),
    maven.artifact("io.projectreactor", "reactor-core", "3.4.15"),
    ...
    maven.artifact("org.pitest", "pitest", "1.7.4"),
    maven.artifact("org.pitest", "pitest-aggregator", "1.7.4"),
    maven.artifact("org.pitest", "pitest-command-line", "1.7.4"),
    maven.artifact("org.pitest", "pitest-entry", "1.7.4"),
    maven.artifact("org.pitest", "pitest-html-report", "1.7.4"),
    maven.artifact("org.reactivestreams", "reactive-streams", "1.0.3"),
    maven.artifact("org.slf4j", "slf4j-api", "1.7.36"),
    maven.artifact("org.springframework.boot", "spring-boot", "2.6.4"),
    ...
    maven.artifact("org.springframework", "spring-aop", "5.3.16"),
    maven.artifact("org.springframework", "spring-beans", "5.3.16"),
    maven.artifact("org.springframework", "spring-context", "5.3.16"),
    maven.artifact("org.springframework", "spring-core", "5.3.16"),
    maven.artifact("org.springframework", "spring-expression", "5.3.16"),
    maven.artifact("org.springframework", "spring-jcl", "5.3.16"),
    maven.artifact("org.springframework", "spring-web", "5.3.16"),
    maven.artifact("org.yaml", "snakeyaml", "1.29"),
    maven.artifact("software.amazon.awssdk", "annotations", "2.17.150"),
    maven.artifact("software.amazon.awssdk", "apache-client", "2.17.150"),
    maven.artifact("software.amazon.awssdk", "arns", "2.17.150"),
    maven.artifact("software.amazon.awssdk", "auth", "2.17.150"),
    maven.artifact("software.amazon.awssdk", "aws-core", "2.17.150"),
    maven.artifact("software.amazon.awssdk", "aws-query-protocol", "2.17.150"),
    maven.artifact("software.amazon.awssdk", "aws-xml-protocol", "2.17.150"),
    maven.artifact("software.amazon.awssdk", "http-client-spi", "2.17.150"),
    maven.artifact("software.amazon.awssdk", "json-utils", "2.17.150"),
    maven.artifact("software.amazon.awssdk", "metrics-spi", "2.17.150"),
    maven.artifact("software.amazon.awssdk", "netty-nio-client", "2.17.150"),
    maven.artifact("software.amazon.awssdk", "profiles", "2.17.150"),
    maven.artifact("software.amazon.awssdk", "protocol-core", "2.17.150"),
    maven.artifact("software.amazon.awssdk", "regions", "2.17.150"),
    maven.artifact("software.amazon.awssdk", "s3", "2.17.150"),
    maven.artifact("software.amazon.awssdk", "sdk-core", "2.17.150"),
    maven.artifact("software.amazon.awssdk", "third-party-jackson-core", "2.17.150"),
    maven.artifact("software.amazon.awssdk", "utils", "2.17.150"),
