...
ARTIFACTS = [
    ...
    maven.artifact("com.google.api", "api-common", "2.9.0"),
    maven.artifact("com.google.api-client", "google-api-client", "2.2.0"),
    maven.artifact("com.google.api", "gax", "2.26.0"),
    maven.artifact("com.google.api", "gax-grpc", "2.26.0"),
    maven.artifact("com.google.api", "gax-httpjson", "0.111.0"),
    maven.artifact("com.google.api.grpc", "gapic-google-cloud-storage-v2", "2.22.1-alpha"),
    maven.artifact("com.google.api.grpc", "grpc-google-cloud-storage-v2", "2.22.1-alpha"),
    maven.artifact("com.google.api.grpc", "proto-google-cloud-storage-v2", "2.22.1-alpha"),
    maven.artifact("com.google.api.grpc", "proto-google-common-protos", "2.18.0"),
    maven.artifact("com.google.api.grpc", "proto-google-iam-v1", "1.12.0"),
    ...
    maven.artifact("com.google.cloud", "google-cloud-core", "2.16.0"),
    maven.artifact("com.google.cloud", "google-cloud-core-grpc", "2.16.0"),
    maven.artifact("com.google.cloud", "google-cloud-core-http", "2.16.0"),
    maven.artifact("com.google.cloud", "google-cloud-storage", "2.22.1"),
    ...
    maven.artifact("io.netty", "netty-buffer", "4.1.91.Final"),
    maven.artifact("io.netty", "netty-codec", "4.1.91.Final"),
    maven.artifact("io.netty", "netty-codec-dns", "4.1.91.Final"),
    maven.artifact("io.netty", "netty-codec-http", "4.1.91.Final"),
    maven.artifact("io.netty", "netty-codec-http2", "4.1.91.Final"),
    maven.artifact("io.netty", "netty-codec-socks", "4.1.91.Final"),
    maven.artifact("io.netty", "netty-common", "4.1.91.Final"),
    maven.artifact("io.netty", "netty-handler", "4.1.91.Final"),
    maven.artifact("io.netty", "netty-handler-proxy", "4.1.91.Final"),
    maven.artifact("io.netty", "netty-resolver", "4.1.91.Final"),
    maven.artifact("io.netty", "netty-resolver-dns", "4.1.91.Final"),
    maven.artifact("io.netty", "netty-resolver-dns-classes-macos", "4.1.91.Final"),
    maven.artifact("io.netty", "netty-resolver-dns-native-macos", "4.1.91.Final", classifier = "osx-x86_64"),
    maven.artifact("io.netty", "netty-tcnative-boringssl-static", "2.0.59.Final"),
    maven.artifact("io.netty", "netty-tcnative-classes", "2.0.59.Final"),
    maven.artifact("io.netty", "netty-transport", "4.1.91.Final"),
    maven.artifact("io.netty", "netty-transport-classes-epoll", "4.1.91.Final"),
    maven.artifact("io.netty", "netty-transport-classes-kqueue", "4.1.91.Final"),
    maven.artifact("io.netty", "netty-transport-native-epoll", "4.1.91.Final", classifier = "linux-x86_64"),
    maven.artifact("io.netty", "netty-transport-native-kqueue", "4.1.91.Final", classifier = "osx-x86_64"),
    maven.artifact("io.netty", "netty-transport-native-unix-common", "4.1.91.Final"),
    ...
    maven.artifact("io.projectreactor.netty", "reactor-netty-core", "1.0.31"),
    maven.artifact("io.projectreactor.netty", "reactor-netty-http", "1.0.31"),
    ...
    maven.artifact("org.springframework.boot", "spring-boot", "2.7.11"),
    ...
    maven.artifact("software.amazon.awssdk", "annotations", "2.20.66"),
    maven.artifact("software.amazon.awssdk", "apache-client", "2.20.66"),
    maven.artifact("software.amazon.awssdk", "arns", "2.20.66"),
    maven.artifact("software.amazon.awssdk", "auth", "2.20.66"),
    maven.artifact("software.amazon.awssdk", "aws-core", "2.20.66"),
    maven.artifact("software.amazon.awssdk", "aws-query-protocol", "2.20.66"),
    maven.artifact("software.amazon.awssdk", "aws-xml-protocol", "2.20.66"),
    maven.artifact("software.amazon.awssdk", "crt-core", "2.20.66"),
    maven.artifact("software.amazon.awssdk", "endpoints-spi", "2.20.66"),
    maven.artifact("software.amazon.awssdk", "http-client-spi", "2.20.66"),
    maven.artifact("software.amazon.awssdk", "json-utils", "2.20.66"),
    maven.artifact("software.amazon.awssdk", "metrics-spi", "2.20.66"),
    maven.artifact("software.amazon.awssdk", "netty-nio-client", "2.20.66"),
    maven.artifact("software.amazon.awssdk", "profiles", "2.20.66"),
    maven.artifact("software.amazon.awssdk", "protocol-core", "2.20.66"),
    maven.artifact("software.amazon.awssdk", "regions", "2.20.66"),
    maven.artifact("software.amazon.awssdk", "s3", "2.20.66"),
    maven.artifact("software.amazon.awssdk", "sdk-core", "2.20.66"),
    maven.artifact("software.amazon.awssdk", "third-party-jackson-core", "2.20.66"),
    maven.artifact("software.amazon.awssdk", "utils", "2.20.66"),
