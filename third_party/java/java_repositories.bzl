...
ARTIFACTS = [
    ...
    maven.artifact("com.azure", "azure-core", "1.54.0"),
    maven.artifact("com.azure", "azure-core-http-netty", "1.15.6"),
    maven.artifact("com.azure", "azure-json", "1.3.0"),
    maven.artifact("com.azure", "azure-storage-blob", "12.29.0"),
    maven.artifact("com.azure", "azure-storage-common", "12.28.0"),
    maven.artifact("com.azure", "azure-storage-internal-avro", "12.14.0"),
    maven.artifact("com.azure", "azure-xml", "1.1.0"),
    maven.artifact("com.ethlo.time", "itu", "1.10.3"),
    ...
    maven.artifact("com.google.api", "api-common", "2.42.1"),
    maven.artifact("com.google.api", "gax", "2.59.1"),
    maven.artifact("com.google.api", "gax-grpc", "2.59.1"),
    maven.artifact("com.google.api", "gax-httpjson", "2.59.1"),
    maven.artifact("com.google.api-client", "google-api-client", "2.7.1"),
    maven.artifact("com.google.api.grpc", "gapic-google-cloud-storage-v2", "2.47.0"),
    maven.artifact("com.google.api.grpc", "grpc-google-cloud-storage-v2", "2.47.0"),
    maven.artifact("com.google.api.grpc", "proto-google-cloud-monitoring-v3", "3.52.0"),
    maven.artifact("com.google.api.grpc", "proto-google-cloud-storage-v2", "2.47.0"),
    maven.artifact("com.google.api.grpc", "proto-google-common-protos", "2.50.1"),
    maven.artifact("com.google.api.grpc", "proto-google-iam-v1", "1.45.1"),
    maven.artifact("com.google.apis", "google-api-services-storage", "v1-rev20241206-2.0.0"),
    maven.artifact("com.google.auth", "google-auth-library-credentials", "1.30.1"),
    maven.artifact("com.google.auth", "google-auth-library-oauth2-http", "1.30.1"),
    maven.artifact("com.google.auto.value", "auto-value", "1.11.0"),
    maven.artifact("com.google.auto.value", "auto-value-annotations", "1.11.0"),
    maven.artifact("com.google.cloud", "google-cloud-core", "2.49.1"),
    maven.artifact("com.google.cloud", "google-cloud-core-grpc", "2.49.1"),
    maven.artifact("com.google.cloud", "google-cloud-core-http", "2.49.1"),
    maven.artifact("com.google.cloud", "google-cloud-monitoring", "3.52.0"),
    maven.artifact("com.google.cloud", "google-cloud-storage", "2.47.0"),
    maven.artifact("com.google.cloud.opentelemetry", "detector-resources-support", "0.33.0"),
    maven.artifact("com.google.cloud.opentelemetry", "exporter-metrics", "0.33.0"),
    maven.artifact("com.google.cloud.opentelemetry", "shared-resourcemapping", "0.33.0"),
    maven.artifact("com.google.code.findbugs", "jsr305", "3.0.2"),
    maven.artifact("com.google.code.gson", "gson", "2.11.0"),
    maven.artifact("com.google.errorprone", "error_prone_annotations", "2.36.0"),
    ...
    maven.artifact("com.google.http-client", "google-http-client", "1.45.3"),
    maven.artifact("com.google.http-client", "google-http-client-apache-v2", "1.45.3"),
    maven.artifact("com.google.http-client", "google-http-client-appengine", "1.45.3"),
    maven.artifact("com.google.http-client", "google-http-client-gson", "1.45.3"),
    maven.artifact("com.google.http-client", "google-http-client-jackson2", "1.45.3"),
    maven.artifact("com.google.j2objc", "j2objc-annotations", "3.0.0"),
    maven.artifact("com.google.jimfs", "jimfs", "1.3.0"),
    maven.artifact("com.google.oauth-client", "google-oauth-client", "1.37.0"),
    maven.artifact("com.google.protobuf", "protobuf-java", "4.29.3"),
    maven.artifact("com.google.protobuf", "protobuf-java-util", "4.29.3"),
    maven.artifact("com.google.protobuf", "protobuf-kotlin", "4.29.3"),
    ...
    maven.artifact("com.networknt", "json-schema-validator", "1.5.5"),
    ...
    maven.artifact("io.grpc", "grpc-alts", "1.69.1"),
    maven.artifact("io.grpc", "grpc-api", "1.69.1"),
    maven.artifact("io.grpc", "grpc-auth", "1.69.1"),
    maven.artifact("io.grpc", "grpc-context", "1.69.1"),
    maven.artifact("io.grpc", "grpc-core", "1.69.1", exclusions = ["io.grpc:grpc-util"]),
    maven.artifact("io.grpc", "grpc-googleapis", "1.69.1"),
    maven.artifact("io.grpc", "grpc-grpclb", "1.69.1"),
    maven.artifact("io.grpc", "grpc-inprocess", "1.69.1"),
    maven.artifact("io.grpc", "grpc-kotlin-stub", "1.4.1"),
    maven.artifact("io.grpc", "grpc-netty-shaded", "1.69.1"),
    maven.artifact("io.grpc", "grpc-opentelemetry", "1.69.1"),
    maven.artifact("io.grpc", "grpc-protobuf", "1.69.1"),
    maven.artifact("io.grpc", "grpc-protobuf-lite", "1.69.1"),
    maven.artifact("io.grpc", "grpc-rls", "1.69.1"),
    maven.artifact("io.grpc", "grpc-services", "1.69.1"),
    maven.artifact("io.grpc", "grpc-stub", "1.69.1"),
    maven.artifact("io.grpc", "grpc-util", "1.69.1"),
    maven.artifact("io.grpc", "grpc-xds", "1.69.1"),
    ...
    maven.artifact("io.opentelemetry", "opentelemetry-api", "1.46.0"),
    maven.artifact("io.opentelemetry", "opentelemetry-api-incubator", "1.46.0-alpha"),
    maven.artifact("io.opentelemetry", "opentelemetry-context", "1.46.0"),
    maven.artifact("io.opentelemetry", "opentelemetry-sdk", "1.46.0"),
    maven.artifact("io.opentelemetry", "opentelemetry-sdk-common", "1.46.0"),
    maven.artifact("io.opentelemetry", "opentelemetry-sdk-extension-autoconfigure-spi", "1.46.0"),
    maven.artifact("io.opentelemetry", "opentelemetry-sdk-logs", "1.46.0"),
    maven.artifact("io.opentelemetry", "opentelemetry-sdk-metrics", "1.46.0"),
    maven.artifact("io.opentelemetry", "opentelemetry-sdk-trace", "1.46.0"),
    maven.artifact("io.opentelemetry.contrib", "opentelemetry-gcp-resources", "1.37.0-alpha"),
    maven.artifact("io.opentelemetry.semconv", "opentelemetry-semconv", "1.27.0-alpha"),
    ...
    maven.artifact("org.checkerframework", "checker-qual", "3.48.3"),
    ...
    maven.artifact("org.pitest", "pitest", "1.17.4"),
    maven.artifact("org.pitest", "pitest-aggregator", "1.17.4"),
    maven.artifact("org.pitest", "pitest-command-line", "1.17.4"),
    maven.artifact("org.pitest", "pitest-entry", "1.17.4"),
    maven.artifact("org.pitest", "pitest-html-report", "1.17.4"),
    ...
    maven.artifact("software.amazon.awssdk", "annotations", "2.30.1"),
    maven.artifact("software.amazon.awssdk", "apache-client", "2.30.1"),
    maven.artifact("software.amazon.awssdk", "arns", "2.30.1"),
    maven.artifact("software.amazon.awssdk", "auth", "2.30.1"),
    maven.artifact("software.amazon.awssdk", "aws-core", "2.30.1"),
    maven.artifact("software.amazon.awssdk", "aws-query-protocol", "2.30.1"),
    maven.artifact("software.amazon.awssdk", "aws-xml-protocol", "2.30.1"),
    maven.artifact("software.amazon.awssdk", "checksums", "2.30.1"),
    maven.artifact("software.amazon.awssdk", "checksums-spi", "2.30.1"),
    maven.artifact("software.amazon.awssdk", "crt-core", "2.30.1"),
    maven.artifact("software.amazon.awssdk", "endpoints-spi", "2.30.1"),
    maven.artifact("software.amazon.awssdk", "http-auth", "2.30.1"),
    maven.artifact("software.amazon.awssdk", "http-auth-aws", "2.30.1"),
    maven.artifact("software.amazon.awssdk", "http-auth-aws-eventstream", "2.30.1"),
    maven.artifact("software.amazon.awssdk", "http-auth-spi", "2.30.1"),
    maven.artifact("software.amazon.awssdk", "http-client-spi", "2.30.1"),
    maven.artifact("software.amazon.awssdk", "identity-spi", "2.30.1"),
    maven.artifact("software.amazon.awssdk", "json-utils", "2.30.1"),
    maven.artifact("software.amazon.awssdk", "metrics-spi", "2.30.1"),
    maven.artifact("software.amazon.awssdk", "netty-nio-client", "2.30.1"),
    maven.artifact("software.amazon.awssdk", "profiles", "2.30.1"),
    maven.artifact("software.amazon.awssdk", "protocol-core", "2.30.1"),
    maven.artifact("software.amazon.awssdk", "regions", "2.30.1"),
    maven.artifact("software.amazon.awssdk", "retries", "2.30.1"),
    maven.artifact("software.amazon.awssdk", "retries-spi", "2.30.1"),
    maven.artifact("software.amazon.awssdk", "s3", "2.30.1"),
    maven.artifact("software.amazon.awssdk", "sdk-core", "2.30.1"),
    maven.artifact("software.amazon.awssdk", "third-party-jackson-core", "2.30.1"),
    maven.artifact("software.amazon.awssdk", "utils", "2.30.1"),
