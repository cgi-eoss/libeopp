...
ARTIFACTS = [
    ...
    maven.artifact("com.fasterxml.jackson.core", "jackson-annotations", "2.18.1"),
    maven.artifact("com.fasterxml.jackson.core", "jackson-core", "2.18.1"),
    maven.artifact("com.fasterxml.jackson.core", "jackson-databind", "2.18.1"),
    maven.artifact("com.fasterxml.jackson.dataformat", "jackson-dataformat-xml", "2.18.1"),
    maven.artifact("com.fasterxml.jackson.dataformat", "jackson-dataformat-yaml", "2.18.1"),
    maven.artifact("com.fasterxml.jackson.datatype", "jackson-datatype-jsr310", "2.18.1"),
    maven.artifact("com.fasterxml.jackson.module", "jackson-module-kotlin", "2.18.1"),
    ...
    maven.artifact("com.google.protobuf", "protobuf-java", "4.28.3"),
    maven.artifact("com.google.protobuf", "protobuf-java-util", "4.28.3"),
    maven.artifact("com.google.protobuf", "protobuf-kotlin", "4.28.3"),
    ...
    maven.artifact("com.networknt", "json-schema-validator", "1.5.3"),
    ...
    maven.artifact("io.grpc", "grpc-alts", "1.68.1"),
    maven.artifact("io.grpc", "grpc-api", "1.68.1"),
    maven.artifact("io.grpc", "grpc-auth", "1.68.1"),
    maven.artifact("io.grpc", "grpc-context", "1.68.1"),
    maven.artifact("io.grpc", "grpc-core", "1.68.1", exclusions = ["io.grpc:grpc-util"]),
    maven.artifact("io.grpc", "grpc-googleapis", "1.68.1"),
    maven.artifact("io.grpc", "grpc-grpclb", "1.68.1"),
    maven.artifact("io.grpc", "grpc-inprocess", "1.68.1"),
    maven.artifact("io.grpc", "grpc-kotlin-stub", "1.4.1"),
    maven.artifact("io.grpc", "grpc-netty-shaded", "1.68.1"),
    maven.artifact("io.grpc", "grpc-opentelemetry", "1.68.1"),
    maven.artifact("io.grpc", "grpc-protobuf", "1.68.1"),
    maven.artifact("io.grpc", "grpc-protobuf-lite", "1.68.1"),
    maven.artifact("io.grpc", "grpc-rls", "1.68.1"),
    maven.artifact("io.grpc", "grpc-s2a", "1.68.1"),
    maven.artifact("io.grpc", "grpc-services", "1.68.1"),
    maven.artifact("io.grpc", "grpc-stub", "1.68.1"),
    maven.artifact("io.grpc", "grpc-util", "1.68.1"),
    maven.artifact("io.grpc", "grpc-xds", "1.68.1"),
    maven.artifact("io.micrometer", "micrometer-commons", "1.14.1"),
    maven.artifact("io.micrometer", "micrometer-observation", "1.14.1"),
    maven.artifact("io.netty", "netty-buffer", "4.1.115.Final"),
    maven.artifact("io.netty", "netty-codec", "4.1.115.Final"),
    maven.artifact("io.netty", "netty-codec-dns", "4.1.115.Final"),
    maven.artifact("io.netty", "netty-codec-http", "4.1.115.Final"),
    maven.artifact("io.netty", "netty-codec-http2", "4.1.115.Final"),
    maven.artifact("io.netty", "netty-codec-socks", "4.1.115.Final"),
    maven.artifact("io.netty", "netty-common", "4.1.115.Final"),
    maven.artifact("io.netty", "netty-handler", "4.1.115.Final"),
    maven.artifact("io.netty", "netty-handler-proxy", "4.1.115.Final"),
    maven.artifact("io.netty", "netty-resolver", "4.1.115.Final"),
    maven.artifact("io.netty", "netty-resolver-dns", "4.1.115.Final"),
    maven.artifact("io.netty", "netty-resolver-dns-classes-macos", "4.1.115.Final"),
    maven.artifact("io.netty", "netty-resolver-dns-native-macos", "4.1.115.Final", classifier = "osx-x86_64"),
    ...
    maven.artifact("io.netty", "netty-transport", "4.1.115.Final"),
    maven.artifact("io.netty", "netty-transport-classes-epoll", "4.1.115.Final"),
    maven.artifact("io.netty", "netty-transport-classes-kqueue", "4.1.115.Final"),
    maven.artifact("io.netty", "netty-transport-native-epoll", "4.1.115.Final", classifier = "linux-x86_64"),
    maven.artifact("io.netty", "netty-transport-native-kqueue", "4.1.115.Final", classifier = "osx-x86_64"),
    maven.artifact("io.netty", "netty-transport-native-unix-common", "4.1.115.Final"),
    ...
    maven.artifact("io.opentelemetry", "opentelemetry-api", "1.44.1"),
    maven.artifact("io.opentelemetry", "opentelemetry-api-incubator", "1.44.1-alpha"),
    maven.artifact("io.opentelemetry", "opentelemetry-context", "1.44.1"),
    maven.artifact("io.opentelemetry", "opentelemetry-sdk", "1.44.1"),
    maven.artifact("io.opentelemetry", "opentelemetry-sdk-common", "1.44.1"),
    maven.artifact("io.opentelemetry", "opentelemetry-sdk-extension-autoconfigure-spi", "1.44.1"),
    maven.artifact("io.opentelemetry", "opentelemetry-sdk-logs", "1.44.1"),
    maven.artifact("io.opentelemetry", "opentelemetry-sdk-metrics", "1.44.1"),
    maven.artifact("io.opentelemetry", "opentelemetry-sdk-trace", "1.44.1"),
    ...
    maven.artifact("io.projectreactor", "reactor-core", "3.7.0"),
    maven.artifact("io.projectreactor.netty", "reactor-netty-core", "1.2.0"),
    maven.artifact("io.projectreactor.netty", "reactor-netty-http", "1.2.0"),
    maven.artifact("javax.annotation", "javax.annotation-api", "1.3.2"),
    maven.artifact("junit", "junit", "4.13.2"),
    maven.artifact("net.bytebuddy", "byte-buddy", "1.15.10"),
    maven.artifact("net.bytebuddy", "byte-buddy-agent", "1.15.10"),
    ...
    maven.artifact("org.pitest", "pitest", "1.17.1"),
    maven.artifact("org.pitest", "pitest-aggregator", "1.17.1"),
    maven.artifact("org.pitest", "pitest-command-line", "1.17.1"),
    maven.artifact("org.pitest", "pitest-entry", "1.17.1"),
    maven.artifact("org.pitest", "pitest-html-report", "1.17.1"),
    ...
    maven.artifact("org.springframework", "spring-aop", "6.2.0"),
    maven.artifact("org.springframework", "spring-beans", "6.2.0"),
    maven.artifact("org.springframework", "spring-context", "6.2.0"),
    maven.artifact("org.springframework", "spring-core", "6.2.0"),
    maven.artifact("org.springframework", "spring-expression", "6.2.0"),
    maven.artifact("org.springframework", "spring-jcl", "6.2.0"),
    maven.artifact("org.springframework", "spring-web", "6.2.0"),
    maven.artifact("org.springframework.boot", "spring-boot", "3.4.0"),
    maven.artifact("org.springframework.cloud", "spring-cloud-commons", "4.1.4"),
    maven.artifact("org.springframework.security", "spring-security-crypto", "6.4.1"),
    ...
    maven.artifact("software.amazon.awssdk", "annotations", "2.29.20"),
    maven.artifact("software.amazon.awssdk", "apache-client", "2.29.20"),
    maven.artifact("software.amazon.awssdk", "arns", "2.29.20"),
    maven.artifact("software.amazon.awssdk", "auth", "2.29.20"),
    maven.artifact("software.amazon.awssdk", "aws-core", "2.29.20"),
    maven.artifact("software.amazon.awssdk", "aws-query-protocol", "2.29.20"),
    maven.artifact("software.amazon.awssdk", "aws-xml-protocol", "2.29.20"),
    maven.artifact("software.amazon.awssdk", "checksums", "2.29.20"),
    maven.artifact("software.amazon.awssdk", "checksums-spi", "2.29.20"),
    maven.artifact("software.amazon.awssdk", "crt-core", "2.29.20"),
    maven.artifact("software.amazon.awssdk", "endpoints-spi", "2.29.20"),
    maven.artifact("software.amazon.awssdk", "http-auth", "2.29.20"),
    maven.artifact("software.amazon.awssdk", "http-auth-aws", "2.29.20"),
    maven.artifact("software.amazon.awssdk", "http-auth-aws-eventstream", "2.29.20"),
    maven.artifact("software.amazon.awssdk", "http-auth-spi", "2.29.20"),
    maven.artifact("software.amazon.awssdk", "http-client-spi", "2.29.20"),
    maven.artifact("software.amazon.awssdk", "identity-spi", "2.29.20"),
    maven.artifact("software.amazon.awssdk", "json-utils", "2.29.20"),
    maven.artifact("software.amazon.awssdk", "metrics-spi", "2.29.20"),
    maven.artifact("software.amazon.awssdk", "netty-nio-client", "2.29.20"),
    maven.artifact("software.amazon.awssdk", "profiles", "2.29.20"),
    maven.artifact("software.amazon.awssdk", "protocol-core", "2.29.20"),
    maven.artifact("software.amazon.awssdk", "regions", "2.29.20"),
    maven.artifact("software.amazon.awssdk", "retries", "2.29.20"),
    maven.artifact("software.amazon.awssdk", "retries-spi", "2.29.20"),
    maven.artifact("software.amazon.awssdk", "s3", "2.29.20"),
    maven.artifact("software.amazon.awssdk", "sdk-core", "2.29.20"),
    maven.artifact("software.amazon.awssdk", "third-party-jackson-core", "2.29.20"),
    maven.artifact("software.amazon.awssdk", "utils", "2.29.20"),
