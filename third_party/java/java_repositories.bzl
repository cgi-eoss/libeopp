...
ARTIFACTS = [
    ...
    maven.artifact("ch.qos.logback", "logback-classic", "1.5.11"),
    maven.artifact("ch.qos.logback", "logback-core", "1.5.11"),
    ...
    maven.artifact("com.google.api", "api-common", "2.40.0"),
    maven.artifact("com.google.api", "gax", "2.57.0"),
    maven.artifact("com.google.api", "gax-grpc", "2.57.0"),
    maven.artifact("com.google.api", "gax-httpjson", "2.57.0"),
    maven.artifact("com.google.api-client", "google-api-client", "2.7.0"),
    maven.artifact("com.google.api.grpc", "gapic-google-cloud-storage-v2", "2.44.1-beta"),
    maven.artifact("com.google.api.grpc", "grpc-google-cloud-storage-v2", "2.44.1-beta"),
    maven.artifact("com.google.api.grpc", "proto-google-cloud-monitoring-v3", "3.31.0"),
    maven.artifact("com.google.api.grpc", "proto-google-cloud-storage-v2", "2.44.1-beta"),
    maven.artifact("com.google.api.grpc", "proto-google-common-protos", "2.48.0"),
    maven.artifact("com.google.api.grpc", "proto-google-iam-v1", "1.43.0"),
    maven.artifact("com.google.apis", "google-api-services-storage", "v1-rev20241008-2.0.0"),
    maven.artifact("com.google.auth", "google-auth-library-credentials", "1.29.0"),
    maven.artifact("com.google.auth", "google-auth-library-oauth2-http", "1.29.0"),
    maven.artifact("com.google.auto.value", "auto-value", "1.10.4"),
    maven.artifact("com.google.auto.value", "auto-value-annotations", "1.11.0"),
    maven.artifact("com.google.cloud", "google-cloud-core", "2.47.0"),
    maven.artifact("com.google.cloud", "google-cloud-core-grpc", "2.47.0"),
    maven.artifact("com.google.cloud", "google-cloud-core-http", "2.47.0"),
    maven.artifact("com.google.cloud", "google-cloud-monitoring", "3.31.0"),
    maven.artifact("com.google.cloud", "google-cloud-storage", "2.44.1"),
    ...
    maven.artifact("io.grpc", "grpc-alts", "1.67.1"),
    maven.artifact("io.grpc", "grpc-api", "1.67.1"),
    maven.artifact("io.grpc", "grpc-auth", "1.67.1"),
    maven.artifact("io.grpc", "grpc-context", "1.67.1"),
    maven.artifact("io.grpc", "grpc-core", "1.67.1", exclusions = ["io.grpc:grpc-util"]),
    maven.artifact("io.grpc", "grpc-googleapis", "1.67.1"),
    maven.artifact("io.grpc", "grpc-grpclb", "1.67.1"),
    maven.artifact("io.grpc", "grpc-inprocess", "1.67.1"),
    maven.artifact("io.grpc", "grpc-kotlin-stub", "1.4.1"),
    maven.artifact("io.grpc", "grpc-netty-shaded", "1.67.1"),
    maven.artifact("io.grpc", "grpc-opentelemetry", "1.67.1"),
    maven.artifact("io.grpc", "grpc-protobuf", "1.67.1"),
    maven.artifact("io.grpc", "grpc-protobuf-lite", "1.67.1"),
    maven.artifact("io.grpc", "grpc-rls", "1.67.1"),
    maven.artifact("io.grpc", "grpc-services", "1.67.1"),
    maven.artifact("io.grpc", "grpc-stub", "1.67.1"),
    maven.artifact("io.grpc", "grpc-util", "1.67.1"),
    maven.artifact("io.grpc", "grpc-xds", "1.67.1"),
    maven.artifact("io.micrometer", "micrometer-commons", "1.13.6"),
    maven.artifact("io.micrometer", "micrometer-observation", "1.13.6"),
    maven.artifact("io.netty", "netty-buffer", "4.1.114.Final"),
    maven.artifact("io.netty", "netty-codec", "4.1.114.Final"),
    maven.artifact("io.netty", "netty-codec-dns", "4.1.114.Final"),
    maven.artifact("io.netty", "netty-codec-http", "4.1.114.Final"),
    maven.artifact("io.netty", "netty-codec-http2", "4.1.114.Final"),
    maven.artifact("io.netty", "netty-codec-socks", "4.1.114.Final"),
    maven.artifact("io.netty", "netty-common", "4.1.114.Final"),
    maven.artifact("io.netty", "netty-handler", "4.1.114.Final"),
    maven.artifact("io.netty", "netty-handler-proxy", "4.1.114.Final"),
    maven.artifact("io.netty", "netty-resolver", "4.1.114.Final"),
    maven.artifact("io.netty", "netty-resolver-dns", "4.1.114.Final"),
    maven.artifact("io.netty", "netty-resolver-dns-classes-macos", "4.1.114.Final"),
    maven.artifact("io.netty", "netty-resolver-dns-native-macos", "4.1.114.Final", classifier = "osx-x86_64"),
    ...
    maven.artifact("io.netty", "netty-transport", "4.1.114.Final"),
    maven.artifact("io.netty", "netty-transport-classes-epoll", "4.1.114.Final"),
    maven.artifact("io.netty", "netty-transport-classes-kqueue", "4.1.114.Final"),
    maven.artifact("io.netty", "netty-transport-native-epoll", "4.1.114.Final", classifier = "linux-x86_64"),
    maven.artifact("io.netty", "netty-transport-native-kqueue", "4.1.114.Final", classifier = "osx-x86_64"),
    maven.artifact("io.netty", "netty-transport-native-unix-common", "4.1.114.Final"),
    ...
    maven.artifact("io.opentelemetry", "opentelemetry-api", "1.43.0"),
    maven.artifact("io.opentelemetry", "opentelemetry-api-incubator", "1.43.0-alpha"),
    maven.artifact("io.opentelemetry", "opentelemetry-context", "1.43.0"),
    maven.artifact("io.opentelemetry", "opentelemetry-sdk", "1.43.0"),
    maven.artifact("io.opentelemetry", "opentelemetry-sdk-common", "1.43.0"),
    maven.artifact("io.opentelemetry", "opentelemetry-sdk-extension-autoconfigure-spi", "1.43.0"),
    maven.artifact("io.opentelemetry", "opentelemetry-sdk-logs", "1.43.0"),
    maven.artifact("io.opentelemetry", "opentelemetry-sdk-metrics", "1.43.0"),
    maven.artifact("io.opentelemetry", "opentelemetry-sdk-trace", "1.43.0"),
    ...
    maven.artifact("io.projectreactor", "reactor-core", "3.6.11"),
    maven.artifact("io.projectreactor.netty", "reactor-netty-core", "1.1.23"),
    maven.artifact("io.projectreactor.netty", "reactor-netty-http", "1.1.23"),
    ...
    maven.artifact("org.springframework", "spring-aop", "6.1.14"),
    maven.artifact("org.springframework", "spring-beans", "6.1.14"),
    maven.artifact("org.springframework", "spring-context", "6.1.14"),
    maven.artifact("org.springframework", "spring-core", "6.1.14"),
    maven.artifact("org.springframework", "spring-expression", "6.1.14"),
    maven.artifact("org.springframework", "spring-jcl", "6.1.14"),
    maven.artifact("org.springframework", "spring-web", "6.1.14"),
    maven.artifact("org.springframework.boot", "spring-boot", "3.3.5"),
    maven.artifact("org.springframework.cloud", "spring-cloud-commons", "4.1.4"),
    maven.artifact("org.springframework.security", "spring-security-crypto", "6.3.4"),
    ...
    maven.artifact("software.amazon.awssdk", "annotations", "2.29.1"),
    maven.artifact("software.amazon.awssdk", "apache-client", "2.29.1"),
    maven.artifact("software.amazon.awssdk", "arns", "2.29.1"),
    maven.artifact("software.amazon.awssdk", "auth", "2.29.1"),
    maven.artifact("software.amazon.awssdk", "aws-core", "2.29.1"),
    maven.artifact("software.amazon.awssdk", "aws-query-protocol", "2.29.1"),
    maven.artifact("software.amazon.awssdk", "aws-xml-protocol", "2.29.1"),
    maven.artifact("software.amazon.awssdk", "checksums", "2.29.1"),
    maven.artifact("software.amazon.awssdk", "checksums-spi", "2.29.1"),
    maven.artifact("software.amazon.awssdk", "crt-core", "2.29.1"),
    maven.artifact("software.amazon.awssdk", "endpoints-spi", "2.29.1"),
    maven.artifact("software.amazon.awssdk", "http-auth", "2.29.1"),
    maven.artifact("software.amazon.awssdk", "http-auth-aws", "2.29.1"),
    maven.artifact("software.amazon.awssdk", "http-auth-aws-eventstream", "2.29.1"),
    maven.artifact("software.amazon.awssdk", "http-auth-spi", "2.29.1"),
    maven.artifact("software.amazon.awssdk", "http-client-spi", "2.29.1"),
    maven.artifact("software.amazon.awssdk", "identity-spi", "2.29.1"),
    maven.artifact("software.amazon.awssdk", "json-utils", "2.29.1"),
    maven.artifact("software.amazon.awssdk", "metrics-spi", "2.29.1"),
    maven.artifact("software.amazon.awssdk", "netty-nio-client", "2.29.1"),
    maven.artifact("software.amazon.awssdk", "profiles", "2.29.1"),
    maven.artifact("software.amazon.awssdk", "protocol-core", "2.29.1"),
    maven.artifact("software.amazon.awssdk", "regions", "2.29.1"),
    maven.artifact("software.amazon.awssdk", "retries", "2.29.1"),
    maven.artifact("software.amazon.awssdk", "retries-spi", "2.29.1"),
    maven.artifact("software.amazon.awssdk", "s3", "2.29.1"),
    maven.artifact("software.amazon.awssdk", "sdk-core", "2.29.1"),
    maven.artifact("software.amazon.awssdk", "third-party-jackson-core", "2.29.1"),
    maven.artifact("software.amazon.awssdk", "utils", "2.29.1"),
