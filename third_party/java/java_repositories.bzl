...
ARTIFACTS = [
    ...
    maven.artifact("com.azure", "azure-core", "1.30.0"),
    maven.artifact("com.azure", "azure-core-http-netty", "1.12.3"),
    maven.artifact("com.azure", "azure-storage-blob", "12.18.0"),
    maven.artifact("com.azure", "azure-storage-common", "12.17.0"),
    maven.artifact("com.azure", "azure-storage-internal-avro", "12.4.0"),
    ...
    maven.artifact("com.google.protobuf", "protobuf-java", "3.21.4"),
    maven.artifact("com.google.protobuf", "protobuf-java-util", "3.21.4"),
    maven.artifact("com.google.protobuf", "protobuf-javalite", "3.21.4"),
    maven.artifact("com.google.protobuf", "protobuf-kotlin", "3.21.4"),
    ...
    maven.artifact("io.grpc", "grpc-alts", "1.48.1"),
    maven.artifact("io.grpc", "grpc-api", "1.48.1"),
    maven.artifact("io.grpc", "grpc-auth", "1.48.1"),
    maven.artifact("io.grpc", "grpc-census", "1.48.1"),
    maven.artifact("io.grpc", "grpc-context", "1.48.1"),
    maven.artifact("io.grpc", "grpc-core", "1.48.1"),
    maven.artifact("io.grpc", "grpc-grpclb", "1.48.1"),
    maven.artifact("io.grpc", "grpc-kotlin-stub", "1.3.0"),
    maven.artifact("io.grpc", "grpc-netty", "1.48.1"),
    maven.artifact("io.grpc", "grpc-netty-shaded", "1.48.1"),
    maven.artifact("io.grpc", "grpc-protobuf", "1.48.1"),
    maven.artifact("io.grpc", "grpc-protobuf-lite", "1.48.1"),
    maven.artifact("io.grpc", "grpc-services", "1.48.1"),
    maven.artifact("io.grpc", "grpc-stub", "1.48.1"),
    ...
    maven.artifact("io.netty", "netty-resolver-dns-native-macos", "4.1.79.Final", classifier = "osx-x86_64"),
    ...
    maven.artifact("io.netty", "netty-transport-native-epoll", "4.1.79.Final", classifier = "linux-x86_64"),
    maven.artifact("io.netty", "netty-transport-native-kqueue", "4.1.79.Final", classifier = "osx-x86_64"),
    ...
    maven.artifact("io.projectreactor.netty", "reactor-netty-core", "1.0.21"),
    maven.artifact("io.projectreactor.netty", "reactor-netty-http", "1.0.21"),
    maven.artifact("io.projectreactor", "reactor-core", "3.4.21"),
    maven.artifact("javax.annotation", "javax.annotation-api", "1.3.2"),
    maven.artifact("junit", "junit", "4.13.2"),
    maven.artifact("net.bytebuddy", "byte-buddy", "1.12.12"),
    maven.artifact("net.bytebuddy", "byte-buddy-agent", "1.12.12"),
    ...
    maven.artifact("org.pitest", "pitest", "1.9.3"),
    maven.artifact("org.pitest", "pitest-aggregator", "1.9.3"),
    maven.artifact("org.pitest", "pitest-command-line", "1.9.3"),
    maven.artifact("org.pitest", "pitest-entry", "1.9.3"),
    maven.artifact("org.pitest", "pitest-html-report", "1.9.3"),
    maven.artifact("org.reactivestreams", "reactive-streams", "1.0.4"),
    maven.artifact("org.slf4j", "slf4j-api", "1.7.36"),
    maven.artifact("org.springframework.boot", "spring-boot", "2.7.2"),
    ...
    maven.artifact("org.springframework", "spring-aop", "5.3.22"),
    maven.artifact("org.springframework", "spring-beans", "5.3.22"),
    maven.artifact("org.springframework", "spring-context", "5.3.22"),
    maven.artifact("org.springframework", "spring-core", "5.3.22"),
    maven.artifact("org.springframework", "spring-expression", "5.3.22"),
    maven.artifact("org.springframework", "spring-jcl", "5.3.22"),
    maven.artifact("org.springframework", "spring-web", "5.3.22"),
    maven.artifact("org.yaml", "snakeyaml", "1.30"),
    maven.artifact("software.amazon.awssdk", "annotations", "2.17.242"),
    maven.artifact("software.amazon.awssdk", "apache-client", "2.17.242"),
    maven.artifact("software.amazon.awssdk", "arns", "2.17.242"),
    maven.artifact("software.amazon.awssdk", "auth", "2.17.242"),
    maven.artifact("software.amazon.awssdk", "aws-core", "2.17.242"),
    maven.artifact("software.amazon.awssdk", "aws-query-protocol", "2.17.242"),
    maven.artifact("software.amazon.awssdk", "aws-xml-protocol", "2.17.242"),
    maven.artifact("software.amazon.awssdk", "http-client-spi", "2.17.242"),
    maven.artifact("software.amazon.awssdk", "json-utils", "2.17.242"),
    maven.artifact("software.amazon.awssdk", "metrics-spi", "2.17.242"),
    maven.artifact("software.amazon.awssdk", "netty-nio-client", "2.17.242"),
    maven.artifact("software.amazon.awssdk", "profiles", "2.17.242"),
    maven.artifact("software.amazon.awssdk", "protocol-core", "2.17.242"),
    maven.artifact("software.amazon.awssdk", "regions", "2.17.242"),
    maven.artifact("software.amazon.awssdk", "s3", "2.17.242"),
    maven.artifact("software.amazon.awssdk", "sdk-core", "2.17.242"),
    maven.artifact("software.amazon.awssdk", "third-party-jackson-core", "2.17.242"),
    maven.artifact("software.amazon.awssdk", "utils", "2.17.242"),
